 ...
 *   Chave gerada no Portal CardápioWeb:
 *   Configurações → Integrações → API → Gerar token
 *
 ...
 *   Token para autenticar requisições de webhook recebidas do CardápioWeb.
 *   Configure o mesmo valor em: Portal → Integrações → API → Webhooks → Token.
 */
