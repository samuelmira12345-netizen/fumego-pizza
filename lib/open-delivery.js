 ...
 *   OD_CW_BASE_URL    "URL base"                do CardápioWeb  (ex: https://api.taximachine.com.br/integra/delivery/opendelivery)
 *
...
export async function pushEventToCardapioWeb(orderId, eventType = 'CREATED') {
  ...
  // CardápioWeb/TaxiMachine validates X-App-Id against the portal-configured client_id.
  // Companies confirmed credentials alone are sufficient — no separate AppId registration needed.
